...
[R1,T1,ER1] = icp(nodes_template',nodes',20,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp);
[R1_0,T1_0,ER1_0] = icp(nodes_template',nodes',20,'Matching','kDtree','WorstRejection',0.1);
...
if better_start == 1
    ...
    [Rz90,Tz90,ERz90] = icp(nodes_template',nodesz90',20,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp);
    [Rz90_wr,Tz90_wr,ERz90_wr] = icp(nodes_template',nodesz90',20,'Matching','kDtree','WorstRejection',0.1);
    [Rz180,Tz180,ERz180] = icp(nodes_template',nodesz180',20,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp);
    [Rz180_wr,Tz180_wr,ERz180_wr] = icp(nodes_template',nodesz180',20,'Matching','kDtree','WorstRejection',0.1);
    [Rz270,Tz270,ERz270] = icp(nodes_template',nodesz270',20,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp);
    [Rz270_wr,Tz270_wr,ERz270_wr] = icp(nodes_template',nodesz270',20,'Matching','kDtree','WorstRejection',0.1);
    ...
    [Ry90,Ty90,ERy90] = icp(nodes_template',nodesy90',20,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp);
    [Ry90_wr,Ty90_wr,ERy90_wr] = icp(nodes_template',nodesy90',20,'Matching','kDtree','WorstRejection',0.1);
    [Ry180,Ty180,ERy180] = icp(nodes_template',nodesy180',20,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp);
    [Ry180_wr,Ty180_wr,ERy180_wr] = icp(nodes_template',nodesy180',20,'Matching','kDtree','WorstRejection',0.1);
    [Ry270,Ty270,ERy270] = icp(nodes_template',nodesy270',20,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp);
    [Ry270_wr,Ty270_wr,ERy270_wr] = icp(nodes_template',nodesy270',20,'Matching','kDtree','WorstRejection',0.1);
    ...
    [Rx90,Tx90,ERx90] = icp(nodes_template',nodesx90',20,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp);
    [Rx90_wr,Tx90_wr,ERx90_wr] = icp(nodes_template',nodesx90',20,'Matching','kDtree','WorstRejection',0.1);
    [Rx180,Tx180,ERx180] = icp(nodes_template',nodesx180',20,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp);
    [Rx180_wr,Tx180_wr,ERx180_wr] = icp(nodes_template',nodesx180',20,'Matching','kDtree','WorstRejection',0.1);
    [Rx270,Tx270,ERx270] = icp(nodes_template',nodesx270',20,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp);
    [Rx270_wr,Tx270_wr,ERx270_wr] = icp(nodes_template',nodesx270',20,'Matching','kDtree','WorstRejection',0.1);
...
if (tibfib_switch == 1 && bone_indx == 13) || (tibfib_switch == 1 && bone_indx == 14)
    ...
    [Rtw1,Ttw1,Etw1] = icp(nodes_template',nodes_test1',20,'Matching','kDtree','WorstRejection',0.1);
    [Rtw2,Ttw2,Etw2] = icp(nodes_template',nodes_test2',20,'Matching','kDtree','WorstRejection',0.1);
    [Rtw3,Ttw3,Etw3] = icp(nodes_template',nodes_test3',20,'Matching','kDtree','WorstRejection',0.1);
    [Rtw4,Ttw4,Etw4] = icp(nodes_template',nodes_test4',20,'Matching','kDtree','WorstRejection',0.1);
